To setup backup times Edit -> Preferences -> Zip backup

Zip Backup is an editor extension that will save your projects when you hit Play and backup your projects into a zip file automatically or manually, it will use 7z.exe, that comes with Unity, or Fastzip.exe (http://forum.unity3d.com/threads/android-faster-apk-creation-experimental.327755/), an tool created by Unity that zips files about 23x faster than normal applications.
